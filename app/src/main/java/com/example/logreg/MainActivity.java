...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        adapter.addFragment(new ProfileActivityPassenger(),"");

        viewPager.setAdapter(adapter);
        tabLayout.setupWithViewPager(viewPager);

        tabLayout.getTabAt(0).setIcon(R.drawable.search_vector_full);
        tabLayout.getTabAt(1).setIcon(R.drawable.deploy_vector);
        tabLayout.getTabAt(2).setIcon(R.drawable.car_vector);
        tabLayout.getTabAt(3).setIcon(R.drawable.chat_vector);
        tabLayout.getTabAt(4).setIcon(R.drawable.profile_vector);
